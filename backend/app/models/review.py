...
class Product(BaseModel):
    """Product information for review generation"""
    name: str
...
class Context(BaseModel):
    """Context information for review generation"""
...
class ReviewRequest(BaseModel):
    """Request for review generation (Task A)"""
    user_id: str
    persona_id: str
    product: Product
    context: Context
...
class VoiceProfile(BaseModel):
    """Voice profile used in generation"""
...
class ReviewResponse(BaseModel):
    """Complete response for review generation"""
    success: bool
...
class ReviewEvaluation(BaseModel):
    """Evaluation metrics for generated review"""
